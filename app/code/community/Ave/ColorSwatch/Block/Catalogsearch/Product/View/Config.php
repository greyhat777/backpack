...
class Ave_ColorSwatch_Block_Catalogsearch_Product_View_Config extends Mage_Core_Block_Template
{
    protected $_product;
    ...
    {
        return $this->_configHelper->getDefaultOptions($this->_product) . ', ' . $this->_configHelper->getJsonConfig(
            $this->_product
        );
    }
}
